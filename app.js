...
const options = {
  ...
  apis: ['C:\\Users\\Leandro\\Desktop\\API\\swagger.json'],
};
...
// Adicione a rota para a documentação do Swagger
app.use('C:\\Users\\Leandro\\Desktop\\API\\api-docs', swaggerUi.serve, swaggerUi.setup(specs));
...
app.listen(port, () => {
  ...
  //REQUISITO 2
  app.put('/editaPessoa/:id', async (req, res) => {
      const { id } = req.params;
      const { NameUser, Age, CPF, email, type } = req.body;
    ...
    //REQUISITO 5
    app.post('/cadastrarProjeto', async (req, res) => {
  ...
  //REQUISITO 6
  app.put('/editarProjeto/:id', async (req, res) => {
  ...
  app.get('/projetos', async (req, res) => {
      try {
        ...
        const projetosComPopularidade = projetos.map((projeto) => ({
          ...projeto,
          popularidade: projeto.Application.length,
        }));
  ...
  //REQUISITO 9
  app.get('/candidatosInteressados', async (req, res) => {
      try {
  ...
  //REQUISITO 11
  app.post('/selecionarCandidato', async (req, res) => {
      try {
  ...
  app.get('/candidatosSelecionados/:idProjeto', async (req, res) => {
      try {
